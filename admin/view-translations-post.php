...
<table>
	...
	foreach ( $this->model->get_languages_list() as $language ) {
		...
		?>
		<tr>
			<th class = "pll-language-column"><?php echo $language->flag ? wp_kses_post( $language->flag ) : esc_html( $language->slug ); ?></th>
			<td class = "hidden"><?php echo wp_kses_post( $add_link ); ?></td>
			<td class = "pll-edit-column pll-column-icon"><?php echo wp_kses_post( $link ); ?></td>
			<?php
